...
// Copyright (c) 2014 The SproutsExtreme developers
...
// for both SproutsExtremed and SproutsExtreme(-qt), to make it harder for attackers to
// target servers or GUI users specifically.

// For the current run of SproutsExtreme releases, the client name should be selected from
