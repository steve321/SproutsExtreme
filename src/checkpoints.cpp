...
namespace Checkpoints
{
    ...
    static MapCheckpoints mapCheckpoints =
        ...
        (  8535, uint256("0x00000000000000601ec39e079064557fedaf0d8f92d86874a904ea4e33cceb75"))
        ;
    ...
    // SproutsExtreme: synchronized checkpoint (centrally broadcasted)
    ...
    // SproutsExtreme: get last synchronized checkpoint
    ...
    // SproutsExtreme: only descendant of current sync-checkpoint is allowed
    ...
    // SproutsExtreme: reset synchronized checkpoint to last hardened checkpoint
...
// SproutsExtreme: sync-checkpoint master key
...
// SproutsExtreme: verify signature of sync-checkpoint message
...
// SproutsExtreme: process synchronized checkpoint
