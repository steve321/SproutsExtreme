/*
 * Qt4 SproutsExtreme GUI.
 *
 * W.J. van der Laan 2011-2012
 * The Bitcoin Developers 2011-2012
 * The SproutsExtreme Developers 2011-2013
 */
...
{
    resize(850, 550);
    setWindowTitle(tr("SproutsExtreme Wallet"));
#ifndef Q_WS_MAC
    setWindowIcon(QIcon(":icons/SproutsExtreme_icon"));
#else
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a SproutsExtreme address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/SproutsExtreme_tooltip"), tr("&About SproutsExtreme"), this);
    aboutAction->setToolTip(tr("Show information about SproutsExtreme"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for SproutsExtreme"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/SproutsExtreme_tooltip"), tr("Show/Hide &SproutsExtreme"), this);
    toggleHideAction->setToolTip(tr("Show or hide the SproutsExtreme window"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        if(clientModel->isTestNet())
        {
            ...
            setWindowIcon(QIcon(":icons/SproutsExtreme_icon"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/SproutsExtreme_icon"));
#endif
            if(trayIcon)
            {
                trayIcon->setToolTip(title_testnet);
                trayIcon->setIcon(QIcon(":/icons/SproutsExtreme_tooltip"));
            }
        }
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("SproutsExtreme client"));
    trayIcon->setIcon(QIcon(":/icons/SproutsExtreme_tooltip"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to SproutsExtreme network", "", count));
}
